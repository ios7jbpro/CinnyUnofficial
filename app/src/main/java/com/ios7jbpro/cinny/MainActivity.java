...
public class MainActivity extends Activity {
	...
	public final int REQ_CD_UPLOADCINNYAPI = 101;
	...
	private Intent uploadCinnyAPI = new Intent(Intent.ACTION_GET_CONTENT);
	private TimerTask showFinishButton;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		uploadCinnyAPI.setType("*/*");
		uploadCinnyAPI.putExtra(Intent.EXTRA_ALLOW_MULTIPLE, true);
	...
	private void initializeLogic() {
		...
		webview1.loadUrl("https://app.cinny.in/");
	}
	...
	public void onBackPressed() {
		...
		textview1.setText("Quit(2)");
		showFinishButton = new TimerTask() {
			@Override
			public void run() {
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
						textview1.setText("Quit(1)");
						showFinishButton = new TimerTask() {
							@Override
							public void run() {
								runOnUiThread(new Runnable() {
										...
										showFinishButton = new TimerTask() {
											...
											public void run() {
												runOnUiThread(new Runnable() {
													...
													public void run() {
														linear2.setVisibility(View.GONE);
														textview1.setText("Quit");
													}
												});
											}
										};
										_timer.schedule(showFinishButton, (int)(1000));
									}
								});
							}
						};
